...
namespace NPOItest.Models.Sevices
{
    ...
    {
        private NPOI_DBAccount db = new NPOI_DBAccount();
        ...
        public XSSFWorkbook AccountEmpty_XL(FileStream fs)
        {
            XSSFWorkbook templateWorkbook = new XSSFWorkbook(fs);
            XSSFSheet ws = (XSSFSheet)templateWorkbook.GetSheetAt(0);
        ...
        public IWorkbook AccountData_XL(FileStream fs)
        {

            List<Account> data = db.Account.ToList();
            workbook = new XSSFWorkbook(fs);
            XSSFSheet ws = (XSSFSheet)workbook.GetSheetAt(0);
